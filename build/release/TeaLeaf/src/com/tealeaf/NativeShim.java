...
public class NativeShim {
	...
	public void flurryLogEvent( String eventName, boolean timed ) {
//		logger.log( "NativeShim::flurryLogEvent(): " + eventName + ", " + timed );

		FlurryAgent.logEvent( eventName, timed );
	}

	public void flurryEndTimedEvent( final String eventName ) {
//		logger.log( "NativeShim::flurryEndTimedEvent(): " + eventName );
