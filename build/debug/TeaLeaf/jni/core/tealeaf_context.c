...
void matrix_3x3_set(matrix_3x3 *mat, float a, float b, float c, float d, float e, float f) {
	float a00 = mat->m00;
	float a01 = mat->m10;
	float a02 = mat->m20;
    ...
    mat->m00 = b00 * a00 + b01 * a10 + b02 * a20;
    mat->m10 = b00 * a01 + b01 * a11 + b02 * a21;
    mat->m20 = b00 * a02 + b01 * a12 + b02 * a22;

    mat->m01 = b10 * a00 + b11 * a10 + b12 * a20;
    mat->m11 = b10 * a01 + b11 * a11 + b12 * a21;
    mat->m21 = b10 * a02 + b11 * a12 + b12 * a22;

    mat->m02 = b20 * a00 + b21 * a10 + b22 * a20;
    mat->m12 = b20 * a01 + b21 * a11 + b22 * a21;
    mat->m22 = b20 * a02 + b21 * a12 + b22 * a22;
...
void context_2d_transform(context_2d *ctx, float a, float b, float c, float d, float e, float f) {
	matrix_3x3_set(GET_MODEL_VIEW_MATRIX(ctx), a, b, c, d, e, f);
}
