...
Persistent<String> STRING_CACHE_advertisement;
Persistent<String> STRING_CACHE_loadInterstitial;
Persistent<String> STRING_CACHE_showInterstitial;
Persistent<String> STRING_CACHE_flurry;
Persistent<String> STRING_CACHE_logEvent;
Persistent<String> STRING_CACHE_endTimedEvent;
...
void js_string_cache_init() {
	...
	STRING_CACHE_advertisement = Persistent<String>::New(String::New("advertisement"));
	STRING_CACHE_loadInterstitial = Persistent<String>::New(String::New("loadInterstitial"));
	STRING_CACHE_showInterstitial = Persistent<String>::New(String::New("showInterstitial"));
	STRING_CACHE_flurry = Persistent<String>::New(String::New("flurry"));
	STRING_CACHE_logEvent = Persistent<String>::New(String::New("logEvent"));
	STRING_CACHE_endTimedEvent = Persistent<String>::New(String::New("endTimedEvent"));
}
