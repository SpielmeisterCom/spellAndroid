...
import com.tealeaf.event.KeyEvent;
...
public class TeaLeafGLSurfaceView extends com.tealeaf.GLSurfaceView {
	...
	private int ANDROID_BACK_KEY_CODE = 230;
	...
	public TeaLeafGLSurfaceView(TeaLeaf context, Ads ads) {
		super(context);
		...
		renderer = new Renderer(this, ads);
	...
	public void pauseRuntime() {
		this.context.getSoundQueue().onPause();
		this.setRenderMode( GLSurfaceView.RENDERMODE_WHEN_DIRTY );
	}

	public void resumeRuntime() {
		this.context.getSoundQueue().onResume();
		this.setRenderMode( GLSurfaceView.RENDERMODE_CONTINUOUSLY );
	}

	public void sendKeyDownBack() {
		String[] events = { new KeyEvent( ANDROID_BACK_KEY_CODE, "keydown" ).pack() };

		NativeShim.dispatchEvents( events );
	}

	public void sendKeyUpBack() {
		String[] events = { new KeyEvent( ANDROID_BACK_KEY_CODE, "keyup" ).pack() };
	...
	public static class Renderer implements GLSurfaceView.Renderer,
		...
		public Renderer(TeaLeafGLSurfaceView view, Ads ads) {
		...
		public void onDrawFrame( GL10 gl ) {
			switch( state ) {
				...
				case FIRST_INIT_FAIL:
					...
					state = WAIT_FOR_RETRY;
					handleInitFail( "Connect error", "Unable to contact server to download native.js.mp3" );
					break;
		...
		public void onSurfaceCreated(GL10 gl, EGLConfig config) {
			...
			if (nativeShim == null) {
				...
				nativeShim = new NativeShim(textManager, textureLoader,
						...
						resourceManager, view.context, this.ads);
			}
